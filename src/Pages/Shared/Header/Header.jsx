...
//                                 {
//                                     user && isAdmin && <li> <Link to={'/dashboard/adminHome'}><button>Dashboard</button></Link> </li>
//                                 }
//                                 {
//                                     user && !isAdmin && <li> <Link to={'/dashboard/userHome'}><button>Dashboard</button></Link> </li>
//                                 }
...
const Header = () => {
    ...
    const navLinks = (
        <>
            ...
            {
                user && !isAdmin && isSeller && <li><Link to='/dashboard/sellerHome'>Dashboard</Link></li>
            }
            {
                    ...
                    <div className="navbar-end gap-1 md:gap-3">
                        <div className="dropdown">
                            ...
                            <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                                ...
                                {
                                    user && !isAdmin && isSeller && <li><Link to='/dashboard/sellerHome'><button>Dashboard</button></Link></li>
                                }
                                {
                                    user && !isAdmin && !isSeller && <li><Link to='/dashboard/userHome'><button>Dashboard</button></Link></li>
                                }
                                <li onClick={handleSignOut}><button>Log Out</button></li>
                            </ul>
                        </div>
                        <button onClick={handleSignOut} className="btn">
                            <a id="clickable" className="btn my-anchor-element">Log Out</a>
                            <Tooltip anchorSelect="#clickable" clickable>
                                <p className="">Are You sure?</p>
                            </Tooltip>
                        </button>
